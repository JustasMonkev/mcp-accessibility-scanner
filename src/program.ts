...
function configureBaseProgram() {
  program
      ...
      .option('--image-responses <mode>', 'image response policy: "allow" (default), "omit", or "only". "only" omits text from successful responses with images; errors, structured content and resource links are preserved. "auto" is an alias for "allow".')
