...
- Before committing or pushing, self-review your diff against `.codex/skills/pre-push-review/SKILL.md` — a checklist of the recurring defect patterns automated PR review keeps finding in this repo.
