...
Page-registered WebMCP tools are not currently exposed. See the [WebMCP adoption decision](docs/decisions/001-webmcp-adoption.md) for the proposed deferral and conditions for revisiting an opt-in capability.
